<ul class="nav">
    <?php if( array_key_exists( 'reddit', $widget->links ) ) { ?>
       <li>
		   <a title="Share on Reddit" class="share-facebook <?= $widget->iconSet ?>reddit color-facebook" href="https://reddit.com/submit?url=<?= $widget->url ?>" target="_blank"></a>
	   </li>
    <?php } ?>
    ...
    <?php if( array_key_exists( 'pinterest', $widget->links ) ) { ?>
       <li>
		   <a title="Share on Pinterest" class="share-pinterest <?= $widget->iconSet ?>pinterest color-facebook" href="http://pinterest.com/pin/create/link/?url=<?= $widget->url ?>" target="_blank"></a>
	   </li>
    <?php } ?>
    ...
    <?php if( array_key_exists( 'tumblr', $widget->links ) ) { ?>
       <li>
		   <a title="Share on Tumblr" class="share-tumblr <?= $widget->iconSet ?>tumblr color-facebook" href="https://www.tumblr.com/widgets/share/tool?canonicalUrl=<?= $widget->url ?>" target="_blank"></a>
	   </li>
    <?php } ?>
    <?php if( array_key_exists( 'mix', $widget->links ) ) { ?>
       <li>
		   <a title="Share on Mix" class="share-mix <?= $widget->iconSet ?>mix color-facebook" href="http://mix.com/submit?url=<?= $widget->url ?>" target="_blank"></a>
	   </li>
    <?php } ?>
</ul>
